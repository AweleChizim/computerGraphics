...
int main(int argc, char* argv[]) {
    ...
    backgroundTextures.push_back(loadTexture("./Assets/layer0.png"));
    backgroundTextures.push_back(loadTexture("./Assets/layer1.png"));
    backgroundTextures.push_back(loadTexture("./Assets/layer2.png"));
    backgroundTextures.push_back(loadTexture("./Assets/layer3.png"));
    backgroundTextures.push_back(loadTexture("./Assets/layer4.png"));
    backgroundTextures.push_back(loadTexture("./Assets/layer5.png"));
    backgroundTextures.push_back(loadTexture("./Assets/layer6.png"));
    backgroundTextures.push_back(loadTexture("./Assets/layer7.png"));
    backgroundTextures.push_back(loadTexture("./Assets/layer8.png"));
    backgroundTextures.push_back(loadTexture("./Assets/layer9.png"));
    backgroundTextures.push_back(loadTexture("./Assets/layer10.png"));
    backgroundTextures.push_back(loadTexture("./Assets/layer11.png"));
    ...
    while (!quit) {
        ...
        for (SDL_Texture* texture : backgroundTextures) {
            SDL_Rect textureDest = { 245, 30, 309, 264 };
            SDL_Rect skyDest = { 245, 300, 309, 264 };
            SDL_RenderCopy(gRenderer, texture, NULL, &textureDest);
            SDL_RenderCopy(gRenderer, texture, NULL, &skyDest);
        }
